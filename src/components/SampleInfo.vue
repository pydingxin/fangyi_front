...
export default {
  data() {
    return {
      ...
      columns:[
        ...
        { title: '采样时间', dataIndex: 'CreateTime' },
  ...
  methods: {
    queryInfo(){
      ...
      this.post_api('sample_info', jdata,(ret)=>{
...
<template>
  ...
  <a-space>
    ...
    <a-button id="outportBtn" @click="JSONToExcelConvertor(data, '核酸采样记录')" size="large" type="primary">导出excel</a-button>
